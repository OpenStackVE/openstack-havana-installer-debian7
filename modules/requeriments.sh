...
osreposinstalled=`apt-get -y update|grep "havana/main amd64 Packages"|wc -l`
...
then
	echo ""
	echo "Repositorio de OpenStack Havana Instalado - continuando"
else
	echo ""
	echo "Prerequisito inexistente: Repositorio OpenStack Havana no instalado"
	echo "Abortando"
	echo ""
	exit 0
fi
